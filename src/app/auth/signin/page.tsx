...
export default function SignInPage() {
  ...
  const mode = searchParams.get('mode') as 'homebuyer' | 'investor' | null;
      ...
      >
        <div className="glass-strong rounded-2xl p-8 shadow-2xl">
          ...
          <p className="text-center text-neutral-600 mb-8">
            {mode === 'homebuyer' 
              ? 'Sign in to start your homebuying journey'
              : mode === 'investor'
          ...
          <Button
            ...
            variant="outline"
            size="lg"
            className="w-full rounded-xl gap-3 py-6"
            disabled={signingIn}
          >
            {signingIn ? (
              <>
          ...
          <p className="text-xs text-center text-neutral-500 mt-6">
            By continuing, you agree to Homevest's Terms of Service and Privacy Policy
          </p>
        </div>
      </motion.div>
    </div>
